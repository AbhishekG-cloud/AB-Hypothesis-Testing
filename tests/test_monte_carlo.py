...
con_list = [50, 100, 200, 400, 500, 1000, 10000]
...
def test_prob_B_beats_A_invalid(alpha_A, beta_A, alpha_B, beta_B, n_samples):
    with pytest.raises(ValueError):
        prob_B_beats_A(alpha_A, beta_A, alpha_B, beta_B, n_samples)
...
def test_expected_uplift_invalid(alpha_A, beta_A, alpha_B, beta_B, n_samples):
    with pytest.raises(ValueError):
        expected_uplift(alpha_A, beta_A, alpha_B, beta_B, n_samples)
...
def test_expected_loss_invalid(alpha_A, beta_A, alpha_B, beta_B, n_samples):
    with pytest.raises(ValueError):
        expected_loss(alpha_A, beta_A, alpha_B, beta_B, n_samples)
...
def test_convergence_check_invalid(alpha_A, beta_A, alpha_B, beta_B, _):
    with pytest.raises(ValueError):
        convergence_check(alpha_A, beta_A, alpha_B, beta_B, sample_sizes=con_list)
